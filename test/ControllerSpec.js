...
describe("controller", function () {
  ...
  describe("routing", function () {
    ...
    it("should show active entries", function () {
      ...
      let todo2 = { title: "not todo", completed: true };
  ...
  describe("toggle all", function () {
    ...
    it("should update the view", function () {
      // TODO: write test
      let todo = { id: 2, title: "my todo", completed: false };
  ...
  describe("element removal", function () {
    it("should remove an entry from the model", function () {
      // TODO: write test
      var todo = { id: 2, title: "my todo", completed: true };
      setUpModel([todo]);

      subject.setView("");
      view.trigger("itemRemove", { id: 2 });

      expect(view.render).toHaveBeenCalledWith("removeItem", 2);
    });
